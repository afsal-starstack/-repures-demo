...
const navItems = [
  { name: "Overview", path: "/overview", icon:overviewLogo, reviewTotal:"3" },
...
export default function Sidebar() {
  return (
    <div className="border border-[#4B5563]/20">
...
<span className="ml-auto flex w-[32px] h-[22px] py-[3px] pr-[9px] pl-[13px] items-center 
  ...
  {item.reviewTotal}
      ...
      <div className="text-xs text-gray-500 text-center pt-[17px]">
        © 2026 Repures
      </div>

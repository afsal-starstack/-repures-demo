...
export default function TodayFocus() {
  return (
    <div className="rounded-2xl border border-[#1F2937] bg-[#0D1117] p-[25px] h-[320px]">
...
border border-l-[3.2px]
${item.border} ${item.hoverBorder} ${item.hoverBg}
p-4 cursor-pointer h-[66px]`}
          >
            {/* LEFT */}
            <div className="flex items-center gap-4">
              
              {/* ICON BOX */}
              <div className="w-[32px] h-[32px] rounded-lg flex items-center justify-center bg-[#1F2937]">
                <img
                  src={item.icon}
         ...
         <p className="text-[#D1D5DB] font-roboto font-normal text-[14px] leading-[20px] tracking-normal">
                  {item.text}
                </p>
...
>
  {item.tag}
            ...
            {/* RIGHT */}
            <div className="flex items-center gap-1 text-teal-400 font-roboto font-semibold text-[14px] leading-[20px] text-center">
              View
